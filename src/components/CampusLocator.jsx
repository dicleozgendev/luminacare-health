...
// Campus data (addresses/phones) stays the same regardless of language —
// only the descriptive labels need both. Was entirely hardcoded Turkish;
// this component took a `lang` prop but never used it.
const campusesByLang = {
  tr: {
    maslak: {
  ...
  en: {
    maslak: {
      name: "Maslak Main Medical Complex (General Hospital)",
      address: "Büyükdere Avenue No: 204, Levent / Maslak Medical District, Istanbul",
      phone: "+90 212 988 00 00",
      emergencyPhone: "444 0 911",
      erStatus: "24/7 Emergency & Trauma Center Active",
      parking: "500-Car Free VIP Covered Parking & Valet",
      image: "https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?auto=format&fit=crop&w=600&q=80",
      mapUrl: "https://maps.google.com"
    },
    kadikoy: {
      name: "Kadıköy VIP Clinic & Laser Center",
      address: "Bağdat Avenue No: 312, Suadiye / Kadıköy, Istanbul",
      phone: "+90 216 444 99 22",
      emergencyPhone: "444 0 911",
      erStatus: "Weekdays & Saturday 08:30 - 21:00",
      parking: "Valet & EV Charging Available",
      image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&w=600&q=80",
      mapUrl: "https://maps.google.com"
    },
    ankara: {
      name: "Ankara Çankaya Health Campus",
      address: "Eskişehir Road Km 7, Çankaya Medical Axis, Ankara",
      phone: "+90 312 555 88 11",
      emergencyPhone: "444 0 911",
      erStatus: "24/7 ER & Helicopter Landing Pad",
      parking: "Free Open-Air & Covered Parking",
      image: "https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&fit=crop&w=600&q=80",
      mapUrl: "https://maps.google.com"
    }
  }
...
const uiText = {
  tr: {
    sectionBadge: "Lokasyonlar & Hastane Yerleşkeleri",
    titlePre: "Size En Yakın",
    titleHighlight: "LuminaCare Yerleşkesini Seçin",
    tabMaslak: "İstanbul - Maslak Ana Kompleks",
    tabKadikoy: "İstanbul - Kadıköy Polikliniği",
    tabAnkara: "Ankara - Çankaya Yerleşkesi",
    activeBranch: "Aktif Şube Bilgileri",
    addressLabel: "Adres:",
    hoursLabel: "Çalışma Saatleri & Acil:",
    contactLabel: "Santral & Doğrudan İletişim:",
    emergencyPrefix: "Acil:",
    directions: "Google Maps ile Yol Tarifi Al",
    parkingLabel: "Otopark & Ulaşım Kolaylığı:",
  },
  en: {
    sectionBadge: "Locations & Hospital Campuses",
    titlePre: "Choose Your Closest",
    titleHighlight: "LuminaCare Campus",
    tabMaslak: "Istanbul - Maslak Main Complex",
    tabKadikoy: "Istanbul - Kadıköy Clinic",
    tabAnkara: "Ankara - Çankaya Campus",
    activeBranch: "Active Branch Information",
    addressLabel: "Address:",
    hoursLabel: "Hours & Emergency:",
    contactLabel: "Switchboard & Direct Contact:",
    emergencyPrefix: "Emergency:",
    directions: "Get Directions via Google Maps",
    parkingLabel: "Parking & Access:",
  },
};

export default function CampusLocator({ lang }) {
  const [activeCampus, setActiveCampus] = useState('maslak');
  const campuses = campusesByLang[lang];
  const u = uiText[lang];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="glass-card p-8 md:p-12 border border-slate-800 rounded-3xl grid lg:grid-cols-12 gap-10 items-center shadow-2xl">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div>
              <span className="text-xs font-bold text-emerald-400 uppercase tracking-wider block mb-1">{u.activeBranch}</span>
            ...
            <div className="space-y-4 text-xs text-slate-300">
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 flex items-start gap-3">
                ...
                <div>
                  <strong className="text-white block mb-1">{u.addressLabel}</strong>
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 flex items-start gap-3">
                ...
                <div>
                  <strong className="text-white block mb-1">{u.hoursLabel}</strong>
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 flex items-start gap-3">
                ...
                <div>
                  <strong className="text-white block mb-1">{u.contactLabel}</strong>
                  <span>{current.phone} • {u.emergencyPrefix} {current.emergencyPhone}</span>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-6 relative rounded-2xl overflow-hidden shadow-2xl h-80 md:h-[400px] border border-slate-800">
            ...
            <div className="absolute bottom-4 left-4 right-4 p-3 rounded-xl bg-slate-950/85 backdrop-blur text-xs text-white border border-slate-800">
              <strong className="text-emerald-400 block font-bold mb-0.5">{u.parkingLabel}</strong>
