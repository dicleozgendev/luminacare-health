      ...
      <div className="glass-card max-w-4xl w-full p-6 md:p-8 border border-blue-500/40 relative animate-fadeIn">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Laboratuvar Biyokimya & Radyoloji Görüntüleme Sorgulama</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSearch} className="mb-6 space-y-3">
          ...
          <div className="flex justify-between items-center text-xs">
            ...
            >
              <span>+ {t.loadSampleData} (Örnek: LM-2026-88412)</span>
            </button>

            <span className="text-slate-500">Güvenli 256-Bit SSL Şifreleme</span>
          </div>
        </form>
        ...
        {labData && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
              <div>
                <span className="text-slate-500 block">Hasta Adı Soyadı</span>
                <strong className="text-white text-sm">{labData.patientName}</strong>
              </div>
              <div>
                <span className="text-slate-500 block">Protokol No</span>
                <strong className="text-cyan-400 font-mono">{labData.protocolNo}</strong>
              </div>
              <div>
                <span className="text-slate-500 block">Sorumlu Hekim</span>
                <strong className="text-slate-200">{labData.doctor}</strong>
              </div>
              <div>
                <span className="text-slate-500 block">Onay Tarihi</span>
            ...
            <div>
              <h3 className="text-sm font-bold text-white mb-3 flex items-center justify-between">
                <span>Biyokimya & Kan Tahlil Sonuçları</span>
                <span className="text-xs text-emerald-400 font-normal">Tüm Parametreler Fizyolojik Sınırda</span>
              </h3>
                ...
                <table className="w-full text-left text-xs">
                  <thead className="bg-slate-900 text-slate-400 font-semibold border-b border-slate-800">
                    <tr>
                      ...
                      <th className="p-3">Referans Aralığı</th>
            ...
            <div className="p-4 rounded-xl bg-slate-900/90 border border-slate-800 text-xs">
              <h4 className="font-bold text-cyan-400 mb-1 flex items-center gap-1.5">
                ...
                Radyoloji Uzman Değerlendirme Notu (3T Koroner BT)
              </h4>
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                onClick={() => alert("Laboratuvar Raporu PDF formatında indirildi!")}
